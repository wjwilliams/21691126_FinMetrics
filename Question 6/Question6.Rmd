...
```{r Figure1,  warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Figure1}"}
...
Above I present a table of the weights at the start of the sample period (2011). I then plot the weights over time as shown in Figure \ref{Figure1}.
